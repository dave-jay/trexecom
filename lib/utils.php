 ...
 * @param type $extra
 * 
 * @author  Dave Jay <dave.jay19@gmail.com>
...
function sendSMS($phone, $message = '') {
    try {
        if ($phone != '') {
            ...
            $client = new SoapClient($sms_url . '/Trexecom.asmx?WSDL', array("trace" => 1, "exception" => 0));
            //$client = new SoapClient('http://192.168.72.41/Trexecom.asmx?WSDL', array("trace" => 1, "exception" => 0));
